          ...
          <div className="container-text my-2 lg:my-3">
            <Link
              className={clsx(
                ...
                'group flex w-fit flex-row items-center gap-2 rounded-lg border border-blue-600  px-3 py-2 text-center text-xs font-medium leading-[1.125rem] text-blue-600 transition-all duration-200 ease-in-out hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-4 focus:ring-blue-300',
              )}
