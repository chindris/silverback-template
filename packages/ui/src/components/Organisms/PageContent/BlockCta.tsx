          ...
          <div className="container-text my-2 lg:my-3">
            <Link
              className={clsx(
                ...
                'text-red-600 hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg  py-2 px-3 gap-2 flex flex-row items-center text-xs leading-[1.125rem] font-medium text-center w-fit transition-all duration-200 ease-in-out group',
              )}
...
const ArrowRightIcon = () => (
  ...
  >
    <path
      ...
      className=" fill-red-600 group-hover:fill-white transition-all duration-200 ease-in-out"
    />
  </svg>
);
